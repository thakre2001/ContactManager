            ...
            <div className="row">
              <div className="col">
                ...
                <p className='fst-italic'>
                  Manage all your personal and professional contacts in one place.
                  Easily <strong>add, search, edit, and organize</strong> your contacts
                  with a clean and responsive interface powered by React.js and Spring Boot.
                </p>
              </div>
            </div>
          </div>
