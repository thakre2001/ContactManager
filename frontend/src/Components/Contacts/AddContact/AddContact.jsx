          ...
          <div className="row">
            <div className="col">
              ...
              <p className='fst-italic'>
                Use this form to <strong>add a new contact</strong> by entering details such as
                name, mobile number, email, company, job title, and group.
                Each contact can be categorized and managed efficiently,
                ensuring quick access and better organization.
              </p>
            </div>
            <div className="row">
